...
public class RebuiltOutpost extends Goal {
     ...
     * half the time. Additionally if the outpost does not have game pieces stored this method will not do anything. If
     ...
     * not have game pieces stored this method will not do anything. If you would like to have the human player throw at
